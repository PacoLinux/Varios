...
pattern MMXREGS means[MM0|MM1|MM2|MM3 ];
...
pattern im8reg means[  MM08|MM18|MM28];
pattern um16reg means[ MM0u16|MM1u16|MM2u16];

pattern um8reg means[ MM38u |MM08u|MM18u|MM28u];
pattern om8reg means[MM38o|MM38o|MM28o|MM08o|MM18o|MM28o];
pattern im2reg means[MM332|MM332|MM232|MM032|MM132|MM232];
pattern im4reg means[MM316|MM316|MM216|MM016|MM116|MM216];
pattern untypedmreg means [MM1|MM3|MM3|MM2|MM2|MM0 ];
pattern lmreg means [MM1L|MM3L|MM3L| MM2L|MM0L| MM2L];
...
instruction pattern PMULLSSB(im8reg m1,mreg m2, mrmaddrmode ma)
	...
	assembles['pxor MM7,MM7'   /* clear regs MM2 and mm7 */
		  '\n pxor MM2,MM2'
