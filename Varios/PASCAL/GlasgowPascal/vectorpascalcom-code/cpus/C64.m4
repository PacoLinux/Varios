...
register int64 R0 assembles['r0'] ;
reserved register int64 R1 assembles['r1'] ;
reserved register int64 R2 assembles['rbp'] ; /* Frame Pointer */
alias register int64 FP = R2(0:63) assembles ['rbp'] ;/* Table of Contents */
...
alias  register int32 r0 = R0(0:31)assembles['r0'];
alias register int32 r1 =R1(0:31) assembles['r1'];
alias register int32 r2 =R2(0:31) assembles['r2'];
alias register int32 r3 =R3(0:31) assembles['r3'];
alias register int32 r4 =R4(0:31) assembles['r4'];
alias register int32 r5 =R5(0:31) assembles['r5'];
alias register int32 r6 =R6(0:31) assembles['r6'];
alias register int32 r7 =R7(0:31) assembles['r7'];
...
/* R1 (STACK POINTER) and rbp (TOC) are reserved */
...
alias register uint8 oR8 = R8(0:7)assembles['r8'];
alias register uint8 oR9 = R9(0:7)assembles['r9'];
/* and 16 bit values */
...
alias register int16 sR8 = R8(0:15)assembles['r5'];
alias register int16 sR9 = R9(0:15)assembles['r6'];
...
alias register uint16 huR8 = R8(0:15)assembles['r5'];
alias register uint16 huR9 = R9(0:15)assembles['r6'];
alias register uint16 huR10 = R10(0:15)assembles['r7'];
...
\begin{verbatim}
*/
pattern indexreg means [ R0 | R1 | R2 | R3 | R4 | R5 | R6 | R7 ];
pattern int32reg means [ R8 | R9 | R10 | R11 | R12 | R13 | R14 | R15|r0|r1 |r2|r3|r4|r5|r6|r7];
pattern freg means[F0|F1|F2|F3];
pattern dreg means[D0|D1|D2|D3];
pattern ireg means [ indexreg |int32reg] ;
...
pattern boreg 	means	[ oR3 | oR4 | oR5 | oR6 | oR7|oR8|oR9 ];
pattern breg 	means	[ bireg | bureg | boreg ];
pattern hureg 	means	[ huR3 | huR4 | huR5 | huR6 | huR7 | huR8 | huR9 ];
pattern hreg 	means	[ sR3 | sR4 | sR5 | sR6 | sR7 |sR8|sR9 ];
...
pattern base(indexreg r)						means[^(r)]		assembles	[r];
...
pattern rhs0						means[primfun|dyadic0| minimum|atom|maximum];
...
pattern computed means[primfun|dyadic  |dyadic0];
