...
{                                                                    }
{ TEST 6.6.3.1-10, FILE=CONFv106, CLASS=CONFORMANCE, LEVEL=0          }
{                                                                    }
...
{                                                                    }
{   changed to use a string rather than a packed array of char       }
{   for use in vector pascal                                         }
program CONFv106(output);
var
   pos: integer;
...
if fail or (tra <> 'zzzzydyzyxdyzzydyzyxxdcdbcd') then
   writeln(' FAIL...6.6.3.1-10 (CONFv106)',tra)
else
   writeln(' PASS...6.6.3.1-10 (CONFv106)')
end.
