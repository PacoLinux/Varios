...
public class PPECG extends PPC
{
        ...
        if(p instanceof Unit)
            {
                ...
                w.buf.writeln(name + ":");
                enterInstruction(0, p.lexLevel, w, threadsFlag);
//			w.buf.writeln(" enter  0," + p.lexLevel);
        ...
        if(p.name == "Pmain") threadsFlag = 1; // buf.writeln("bl ThreadsInitial");
        enterInstruction(0, p.lexLevel, w, threadsFlag);
        /*	if (p.toCall != null) {
...
//		w.buf.writeln("leave\n ret " + (p.calleePopsArgs ? p.paramspace : 0));
        ...
        try
            {
                ...
                //String com = "ppu-gcc " + infile + " SI.o " + rtlname + " -o test";
                String com = "ppu-g++ -g PPEcode.cpp SI.csf.o " + rtlname + " " + infile + " -lspe2 -lm -DPPE -o test";
                System.out.println(com);
                // end of PPC & SPE
    ...
    */
    public static boolean sassemble(String infile, String ofile)
    {
        ...
        try
            {
                String com1 = "spu-g++  -O3 SPEcode.cpp -lsimdmath -o SP";
    ...
    */
    ...
    private void enterInstruction(int frameSize, int LL, Walker w,int threadsFlag)
    {
...
//				w.buf.writeln("addi SP, SP, -4");			// SP = SP - 4      ; move the current SP
                ...
                w.buf.writeln("stw TMPREG, 0(SP)");				// mem(SP) = oldSP	; store the new frame pointer
//			w.buf.writeln("addi SP, SP, -4");			// SP = SP - 4      ; move the current SP
            }
