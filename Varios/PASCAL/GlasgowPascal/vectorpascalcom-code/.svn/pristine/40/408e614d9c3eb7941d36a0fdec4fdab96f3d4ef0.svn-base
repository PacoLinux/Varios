...
begin 
   ...
   variable := -10.3; 
   lim:=100;epsilon:=0.001;
   while (variable < 10.3)and(lim>0) do 
   begin 
      lim:=lim-1;
	 
      if (abs(sqr(variable) - variable * variable) < epsilon) then 
         counter := counter+1; 
   ...
   if (counter = 44) then
      ...
      writeln(' FAIL...6.6.6.2-2 (CONF134)',counter) 
end.
