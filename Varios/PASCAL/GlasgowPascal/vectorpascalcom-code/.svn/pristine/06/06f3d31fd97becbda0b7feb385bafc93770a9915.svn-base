/**
 * FindInFiles.java - FindinFiles class for use with the Viper Project. 
  */
...

{
    ...
    public FindInFiles( Viper master)
    {
        super(master, "Find in files", false);
        viper = master;

        viper.filesearchlistPanel.setListData((Vector)null);
        viper.filesearchlistPanel.removeAll();
        viper.filesearchlistPanel.setModel(viper.filesearchModel);
    ...
    public void find()
    {
        ...
        viper.filesearchModel.removeAllElements();
        ...
        viper.tabbedPane3.setSelectedIndex(2);
        while (en1.hasMoreElements()){
            Object obj1 = en1.nextElement();
            String str=obj1.toString();
            viper.filesearchModel.addElement(str.trim());
            MouseListener ml = new MouseAdapter() {	//listen for mouse double click in the Search panel
     		public void mouseClicked(MouseEvent e) {
         		if (e.getClickCount() >= 2) {
             	 		String selected = new String(viper.filesearchlistPanel.getSelectedValue().toString());
 	...
 	viper.filesearchlistPanel.addMouseListener(ml);
