%ifndef ilcgmacros
%define ilcgmacros
; Macro definition file for use with
; Pascal code generators and the Nasm Assembler
; Author Paul Cockshott
; Copyright (c) University of Glasgow 2002
section .text
; Strings assumed to be of unicode chars with 16 bit length word at start
