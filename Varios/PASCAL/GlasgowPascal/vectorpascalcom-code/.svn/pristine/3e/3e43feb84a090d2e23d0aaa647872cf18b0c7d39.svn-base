 ...
 */
public class AVX64CG extends AVX64
{
                                        ...
                                        if(rt.equals(Node.ieee32))
                                            {
                                                switch(floatuse)
                                                    ...
                                                    case 0:
                                                        ...
                                                        pushlist = new Statement(new Assign(book(regfXMM0),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 1:
                                                        // Arg needs to be placed in XMM1
                                                        pushlist = new Statement(new Assign(book(regfXMM1),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 2:
                                                        // Arg needs to be placed in XMM2
                                                        pushlist = new Statement(new Assign(book(regfXMM2),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 3:
                                                        // Arg needs to be placed in XMM3
                                                        pushlist = new Statement(new Assign(book(regfXMM3),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 4:
                                                        // Arg needs to be placed in XMM4
                                                        pushlist = new Statement(new Assign(book(regfXMM4),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 5:
                                                        // Arg needs to be placed in XMM5
                                                        pushlist = new Statement(new Assign(book(regfXMM5),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    default:
                                                        // Put on the stack
                                        ...
                                        else if(rt.equals(Node.ieee64))
                                            {
                                                switch(floatuse)
                                                    ...
                                                    case 0:
                                                        // Arg needs to be placed in XMM0
                                                        pushlist = new Statement(new Assign(book(regdXMM0),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 1:
                                                        // Arg needs to be placed in XMM1
                                                        pushlist = new Statement(new Assign(book(regdXMM1),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 2:
                                                        // Arg needs to be placed in XMM2
                                                        pushlist = new Statement(new Assign(book(regdXMM2),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 3:
                                                        // Arg needs to be placed in XMM3
                                                        pushlist = new Statement(new Assign(book(regdXMM3),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 4:
                                                        // Arg needs to be placed in XMM4
                                                        pushlist = new Statement(new Assign(book(regdXMM4),n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 5:
                                                        // Arg needs to be placed in XMM5
                                                        pushlist = new Statement(new Assign(book(regdXMM5), n),pushlist);
                                                        floatuse++;
                                                        break;
                                                    default:
                                                        // Put on the stack
                                        ...
                                        if(rt.equals(Node.ieee32) || rt.equals(Node.ieee64))
                                            {
                                                switch(floatuse)
                                                    ...
                                                    case 0:
                                                        ...
                                                        pushlist = new Statement(new Assign(book(regdXMM0),new Cast(Node.ieee64,n)),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 1:
                                                        // Arg 2 needs to be placed in XMM1
                                                        pushlist = new Statement(new Assign(book(regdXMM1),new Cast(Node.ieee64,n)),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 2:
                                                        // Arg 3 needs to be placed in XMM2
                                                        pushlist = new Statement(new Assign(book(regdXMM2),new Cast(Node.ieee64,n)),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 3:
                                                        // Arg 4 needs to be placed in XMM3
                                                        pushlist = new Statement(new Assign(book(regdXMM3),new Cast(Node.ieee64,n)),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 4:
                                                        // Arg 5 needs to be placed in XMM4
                                                        pushlist = new Statement(new Assign(book(regdXMM4),new Cast(Node.ieee64,n)),pushlist);
                                                        floatuse++;
                                                        break;
                                                    case 5:
                                                        // Arg 6 needs to be placed in XMM5
                                                        pushlist = new Statement(new Assign(book(regdXMM5),new Cast(Node.ieee64,n)),pushlist);
                                                        floatuse++;
                                                        break;
                                                    default:
                                                        // Put on the stack
