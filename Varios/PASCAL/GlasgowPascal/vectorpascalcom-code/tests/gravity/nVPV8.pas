...
program nvpv8;{nbody simulator using array code}
...
type coord =  array[1..3] of realt;



var i,j,chunk,offs:integer;

    dv:array[1..n] of coord;
...
begin
    ...
    dv:=computevelocitychange(iota[0]);
