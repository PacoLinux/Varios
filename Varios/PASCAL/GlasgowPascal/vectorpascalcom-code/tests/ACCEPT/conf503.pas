...
{                                                                    }
{:This test checks multiplication on arrays   }
...
begin
	...
	vResInt := v1Int * v2Int;
	if (vResInt[1] = 400) and (vResInt[2] = 1000) and (vResInt[3] = 1800) then
	begin
	...
	vResInt := v1Int *c2Int;
	if (vResInt[1] = 40) and (vResInt[2] = 100) and (vResInt[3] = 180) then
	begin
		count := count +1;	
	...
	vResInt := c1Int * c2Int;
	if (vResInt[1] = 4) and (vResInt[2] = 10) and (vResInt[3] = 18) then
	begin
		count := count +1;
