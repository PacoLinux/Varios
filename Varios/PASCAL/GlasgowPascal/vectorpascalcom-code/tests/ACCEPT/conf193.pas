...
{                                                                    }
{ TEST 6.9-2, FILE=CONFv193, CLASS=CONFORMANCE, LEVEL=0               }
{                                                                    }
...
{   modified to use turbo assign to file                             }

program CONFv193(output);
var
   f:text;
   b,c:integer;
...
begin
   ...
   readln(f,c);
   if (b=1) and (c=1) then
      writeln(' PASS...6.9-2 (CONFv193)')
   else
      writeln(' FAIL...6.9-2 (CONFv193)')
end.
