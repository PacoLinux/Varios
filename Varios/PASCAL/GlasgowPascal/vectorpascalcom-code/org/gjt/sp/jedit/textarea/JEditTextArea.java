 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java,v 1.0 2000-07-15 11:24:34+01 steve_lawson Exp steve_lawson $
 */
...
//SL    if (cursorHandle) waitingCursor(false);
	...
	else if(tokenMarker .getClass().getName().endsWith("VPasTokenMarker"))painter.setStyles(SyntaxUtilities.getVPasSyntaxStyles());
	else if(tokenMarker .getClass().getName().endsWith("TeXTokenMarker"))painter.setStyles(SyntaxUtilities.getTeXSyntaxStyles());
	}
